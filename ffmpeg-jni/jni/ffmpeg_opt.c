...
int ffmpeg_parse_options(int argc, char **argv)
{
    ...
    if (ret < 0) {
        av_log(NULL, AV_LOG_INFO, "Error splitting the argument list: ");
        goto fail;
    }
    ...
    if (ret < 0) {
        av_log(NULL, AV_LOG_INFO, "Error parsing global options: ");
        goto fail;
    }
    ...
    if (ret < 0) {
        av_log(NULL, AV_LOG_INFO, "Error opening input files: ");
        goto fail;
    }
    ...
    if (ret < 0) {
        av_log(NULL, AV_LOG_INFO, "Error initializing complex filters.\n");
        goto fail;
    }
    ...
    if (ret < 0) {
        av_log(NULL, AV_LOG_INFO, "Error opening output files: ");
        goto fail;
    }
    ...
    if (ret < 0) {
        av_log(NULL, AV_LOG_INFO, "Error configuring complex filters.\n");
        goto fail;
    }
